...
const faq = [
  ...
  },
  {
    ...
    a: "Нет. Аккаунтов на сайте нет вовсе: уроки, проверки и наставник открыты сразу, ничего заполнять не нужно.",
  },
  {
  ...
  {
    q: "Как вернуться к теме позже?",
    a: "Открой курс и выбери тему из программы — или найди её через поиск по названию и тексту. Ссылка на урок постоянная, её можно сохранить в закладки браузера.",
  },
];
